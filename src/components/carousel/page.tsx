  ...
  return (
    <div className="w-full h-full py-10">
      <h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-white dark:text-neutral-200 font-sans">
        Excerts from Our Tours
        
      </h2>
      <p className="max-w-7xl text-xl pt-3 pl-4 text-white font-bold mx-auto">The Impact we have made</p>
...
const DummyContent = () => {
  return (
    <div className="bg-[#F5F5F7] p-8 md:p-14 rounded-3xl mb-4 overflow-hidden">
