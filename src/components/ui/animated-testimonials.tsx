...
export const AnimatedTestimonials = ({
  ...
  return (
    ...
    className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
        <h1 className="text-white text-4xl font-bold text-center mb-10 -mt-10">About Us</h1>
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20 ">
        ...
        <div className="afterclickk flex justify-between flex-col py-4">
          <motion.div
            key={active}
            initial={{
              y: 20,
      ...
      <div className="flex items-center w-full justify-center m-3">
            <Button
            borderRadius="2rem"
